    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseAssignment_link", x => new { x.AssignmentId, x.ExerciseNumber });
                    table.ForeignKey(
                        name: "FK_ExerciseAssignment_link_assignments_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "assignments",
                        principalColumn: "AssignmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExerciseAssignment_link_exercises_ExerciseNumber",
                        column: x => x.ExerciseNumber,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseAssignment_link_ExerciseNumber",
                table: "ExerciseAssignment_link",
