...
namespace EF_core_Assignment.Migrations
{
    ...
    [Migration("20200414100110_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EF_core_Assignment.Models.ExerciseAssignment_link", b =>
                {
                    b.Property<int>("AssignmentId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("AssignmentId", "ExerciseNumber");

                    b.HasIndex("ExerciseNumber");

                    b.ToTable("ExerciseAssignment_link");
                });
            ...
            modelBuilder.Entity("EF_core_Assignment.Models.ExerciseAssignment_link", b =>
                {
                    b.HasOne("EF_core_Assignment.Models.Assignment", "Assignment")
                        .WithMany("exerciseAssignment_Links")
                        .HasForeignKey("AssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EF_core_Assignment.Models.Exercise", "Exercise")
                        .WithMany("exerciseAssignment_Links")
                        .HasForeignKey("ExerciseNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
